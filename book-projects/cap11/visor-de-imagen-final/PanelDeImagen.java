...
public class PanelDeImagen extends JComponent
{
    ...
    private ImagenOF panelDeImagen;
    ...
    {
        if(panelDeImagen != null) {
            Graphics imageGraphics = panelDeImagen.getGraphics();
            imageGraphics.setColor(Color.LIGHT_GRAY);
            imageGraphics.fillRect(0, 0, ancho, alto);
            repaint();
        }
    }
    ...
    public void paintComponent(Graphics g)
    {
        ...
        if(panelDeImagen != null) {
            g.drawImage(panelDeImagen, 0, 0, null);
        }
    }
}
