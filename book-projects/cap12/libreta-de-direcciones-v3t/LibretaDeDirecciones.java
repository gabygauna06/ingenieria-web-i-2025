...
public class LibretaDeDirecciones
{
    ...
    {
        if(contacto == null) {
            throw new IllegalArgumentException("Se pas� contacto vac�o a modificarContacto.");
        }
        if(claveVieja == null){
            throw new IllegalArgumentException("Se pas� clave vac�a a modificarContacto.");
        }
    ...
    {
        if(clave == null){
            throw new IllegalArgumentException("Se pas� una clave vac�a a eliminarContacto.");
        }
        if(claveEnUso(clave)) {
