...
{
    // Preferencias de tamaño para esta ventana.
    ...
    /**
     * @return El tamaño preferido para esta ventana.
     */
    ...
    private Container setupEntradaDatos()
    {
        ...
        // Configura el area para el numero de telefono.
        Box etiquetaDelAreaTelefono = Box.createHorizontalBox();
        etiquetaDelAreaTelefono.add(new JLabel("Teléfono", JLabel.LEFT));
        ...
        // Configura el area para la direccion.
        Box etiquetaDelAreaDireccion = Box.createHorizontalBox();
        etiquetaDelAreaDireccion.add(new JLabel("Dirección", JLabel.LEFT));
        ...
        // Disposicion de los campos de entrada de datos en el panel.
    ...
    private Container setupAreaBusqueda()
    {
        ...
        etiquetaDelAreaBuscar.add(new JLabel("Search", JLabel.LEFT));
