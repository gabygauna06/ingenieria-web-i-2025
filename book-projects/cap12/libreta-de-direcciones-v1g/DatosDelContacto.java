/**
 * Nombre, dirección y telefono del contacto.
 * 
...
public class DatosDelContacto implements Comparable<DatosDelContacto>
{
    ...
    {
        // Usar texto en blanco si no corresponde un dato.
        if(nombre == null) {
            nombre = "";
        }
        if(telefono == null) {
     ...
     * Los campos para ordenar son nombre, telefono y direccion.
    ...
    /**
     * @return Un texto de múltiples líneas conteniendo el nombre,
    ...
    /**
     * Calcula un código de dispersion utilizando las reglas dadas
     * en "Java Efectivo", de Joshua Bloch.
     * @return Un codigo de dispersión para DatosDelContacto.
     */
    public int hashCode()
    {
        int codigo = 17;
