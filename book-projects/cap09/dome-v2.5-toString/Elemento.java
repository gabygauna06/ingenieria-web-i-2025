 ...
 * Se almacena informacion sobre el elemento que puede ser
 * consultada. Esta clase sirve como una superclase para
 * elementos m�s espec�ficos.
 * 
...
public class Elemento
{
     ...
     * @param comentario El comentario que se ingresar�.
     */
    ...
    /**
     * Pasa a String los detalles de este elemento.
     */
    public String toString()
    {
        String linea = titulo + " (" + duracion + " minutos) ";
        if(loTengo) {
            return linea + "*\n" + "    " + comentario + "\n";
        } else {
            System.out.println();
